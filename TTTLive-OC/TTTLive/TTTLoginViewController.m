...
- (UIViewController *)getPresentedViewController {
    ...
    UITabBarController *tabBarController = [topViewController isKindOfClass:([UITabBarController class])]?[[UITabBarController alloc] init]:nil;
    ...
    UINavigationController *navigationController = [topViewController isKindOfClass:([UINavigationController class])]?[[UINavigationController alloc] init]:nil;
